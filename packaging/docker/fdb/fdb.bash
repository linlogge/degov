...
echo "Starting FDB server on $FORMATTED_PUBLIC_IP:$FDB_PORT (listening on $listen_address)"
fdbserver --listen_address "$listen_address" --public_address "$FORMATTED_PUBLIC_IP:$FDB_PORT" \
